...
4. ~~**Zona horaria de las ventanas de robo/swap.** `JornadaWindowService` usa `Clock.systemDefaultZone()` (UTC en Render): "viernes 16:00" es en realidad las 18:00 (verano) o 17:00 (invierno) en Madrid.~~ ✅ PR #PENDING (deadlines evaluados siempre en `Europe/Madrid`, con horario de verano).
