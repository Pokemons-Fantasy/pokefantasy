...
5. **Settings page layout redesign** — current layout is a single long vertical scroll. Split into two columns: settings fields on the left, sticky sidebar on the right with the save button, a summary of pending changes, and an unsaved-changes indicator. No more scrolling to the bottom to save.
